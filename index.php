...
<body>
    <svg class="circles" width="280px" height="280px" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" fill="none"
    ...
    <div class="container">
        <nav>
            ...
            <div class="nav-element">
                <svg viewBox="-6 -5 36 36" xmlns="http://www.w3.org/2000/svg" fill="none">
                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                    <g id="SVGRepo_iconCarrier">
